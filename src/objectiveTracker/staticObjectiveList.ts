import { FabricatorOpened, GuideOpened } from "./triggers";
...
export const ALL_OBJECTIVES: Objective[] = [
  {
    ...
    details: [
      {
        main: 'Welcome to <abbr style="text-transform: full-width">DOTS</abbr>, the Dyson Swarm Operator Training Simulator.',
        asides: [
          [
      ...
      {
        main: "You may view this message again at any time in the <a>Guide</a>.",
      },
    ],
    steps: [
      [
        ...
        subObjectives: [
          {
            ...
            details: [
              {
                main: "The first order of priority is to set up a basic metal production chain. This will allow you to begin tapping into the planet's resources, an essential step in building the swarm.",
              },
              {
                main: "Metal production starts with <a>miners</a> extracting ore from the planet's crust. Fabricate one, and make sure it is <a>working</a>.",
              },
              {
                main: "<strong>Warning:</strong> You only have a limited starting amount of metal that can be used for fabrication. Until you are producing more, you should be careful not to consume too much or else you will find yourself <a>stuck</a>.",
              },
            ],
            steps: [
          ...
          },
          {
            ...
            details: [
              {
                main: "Now that we are extracting ore, we can proceed to the second part of metal production: refining that ore into metal that can be used for further fabrication.",
              },
              {
                main: "Fabricate a <a>refiner</a>, and make sure it is <a>working</a>.",
              },
            ],
            steps: [
              [
        ...
        subObjectives: [
          {
            ...
            details: [
              {
                main: "With basic metal production set up, the second order of priority is to expand energy production. Mining and refining ore consumes energy, and the full production chain for building the swarm itself will consume even more.",
              },
              {
                main: `<a>Solar collectors</a> convert any radiated energy flux (basically light) that falls upon them into electrical energy that is available to other constructs. You started out with a handful of them, but if you want to continue increasing your production you will need more. Thus, increasing your solar collector count is a good use of your first few ${kilogram} of produced metal.`,
              },
              { main: "Fabricate 10 more <a>collectors</a>." },
            ],
            steps: [
              [
        ...
        subObjectives: [
          {
            ...
            details: [
              {
                main: "The third and final order of priority is producing satellites for the swarm and launching them into orbit to begin assembling the swarm proper.",
              },
              {
                main: "<a>Factories</a> consume <a>metal</a> to produce <a>packaged satellites</a>. Fabricate one, and make sure it is <a>working</a> and well-<a>supplied</a>.",
              },
            ],
            steps: [
              [
          ...
          },
          {
            ...
            details: [
              {
                main: "Once a satellite is assembled and <a>packaged</a> for launch, it can be <a>launched</a> into orbit to begin participating in the <a>swarm</a>.",
              },
              {
                main: "<a>Launchers</a> consume a lot of power to launch a single satellite into orbit. Fabricate one, and make sure it is <a>working</a> and well-<a>supplied</a>.",
              },
            ],
            steps: [
              [
        ...
        subObjectives: [
          {
            ...
            details: [
              {
                main: "Congratulations on launching your first satellite! You have covered all of the fundamental basics required for building a Dyson Swarm.",
              },
            ],
            steps: [
